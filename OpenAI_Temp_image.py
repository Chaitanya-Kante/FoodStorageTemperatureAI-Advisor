...
def read_arduino_data(port='/dev/cu.usbmodem1101', baud_rate=9600, num_readings = 5): #'/dev/cu.usbmodem1101' is the port in the arduino IDE. May differ on devices and USB port used
...
sensor_readings = read_arduino_data('/dev/cu.usbmodem1101', 9600, 5) #'/dev/cu.usbmodem1101' is the port in the arduino IDE. May differ on devices and USB port used
